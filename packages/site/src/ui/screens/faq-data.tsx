...
export const FAQ_ITEMS: FaqEntry[] = [
	...
	},
	{
		...
		a: (
			<>
				Да. При оплате в <TributeLink>Tribute</TributeLink> можно указать, кому предназначена
				подписка&nbsp;— доступ придёт получателю в&nbsp;Telegram-бот автоматически, отдельно
				передавать ему ничего не&nbsp;нужно. Тариф выбирается тот&nbsp;же, что и&nbsp;при обычной
				покупке.
			</>
		),
	},
